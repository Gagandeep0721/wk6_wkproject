...
class Movie(db.Model): 
    ...
    release = db.Column(db.String(150), nullable=True)
    director = db.Column(db.String(100), nullable=True)
    sequel = db.Column(db.String(100))
    ...
    def __init__(self, name, description, price, release, director, sequel, based_on, box_office,
    ...
    def __repr__(self):
        return f"Movie {self.name} has been added to the database! Woohoo!"
    

class MovieSchema(ma.Schema): 
    class Meta:
        fields = ['id', 'name', 'description', 'price', 'release', 'director', 'sequel',
                  'based_on', 'box_office', 'series', 'random_joke']
